...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                "model_name": "poker44-neptune-mlp",
                "model_version": "2",
                "framework": "scikit-learn (calibrated MLP)",
                "license": "MIT",
                ...
                "notes": "Hero-centric behavioral features + calibrated MLP with FPR-budget score recentering.",
            },
        )
